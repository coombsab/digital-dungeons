        ...
        <div class="cards">
          ...
          <label class="card" for="item-1" id="member-1">
            ...
            <div class="desc">
              ...
              <div class="desc-body p-3">
                <span>Welcome to Digital-Dungeons! Poke around and see our
          ...
          <label class="card" for="item-2" id="member-2">
            ...
            <div class="desc">
              ...
              <div class="desc-body p-3">
                <span>Fuzzy Wuzzy was a bear. Fuzzy Wuzzy had no hair. Fuzzy Wuzzy
                  wasn't very fuzzy, was he?</span>
                <hr />
                <span>How much wood would a woodchuck chuck if a woodchuck could
          ...
          <label class="card" for="item-3" id="member-3">
            ...
            <div class="desc">
              ...
              <div class="desc-body p-3">
                <span>Hello I am a junior software developer and this is the
              ...
              <div class="desc-title d-flex justify-content-center">
                ...
                <div class="icons d-flex gap-2 ps-3">
                  <a href="https://github.com/Jakeepaulin" target="_blank" class="mdi mdi-github fs-4"
                    title="GitHub"></a>
                  <a class="mdi mdi-linkedin fs-4" title="LinkedIn" target="_blank"
                    href="https://www.linkedin.com/in/jake-paulin/"></a>
                </div>
              </div>
              <div class="desc-body p-3">
                <span>Welcome to the wild wild west... stay classy and kind
                </span>
              </div>
            </div>
          </label>
          ...
          <label class="card" for="item-5" id="member-5">
            ...
            <div class="desc">
              ...
              <div class="desc-body p-3">
                <span>Hi! My name's Tom and I am a junior developer going through
          ...
          <label class="card" for="item-6" id="member-6">
            <img src="../assets/img/ky.jpg" alt="Ky Want" />
            <div class="desc">
              <div class="desc-title d-flex justify-content-center">
                <h3>Ky Want</h3>
                <div class="icons d-flex gap-2 ps-3">
