<template>
  <div class="component">
    <div class="modal fade" :id="'encounterModal' + encounter.id" tabindex="-1" aria-labelledby="encounterModalLabel"
      aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content bg-secondary">
          ...
          <div class="modal-body">
            <form action="submit" class="card text-secondary" @submit.prevent="editEncounter(encounter.id)">
